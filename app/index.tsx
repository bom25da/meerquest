      ...
      <View style={styles.screen}>
        <ScrollView
          ...
          <View style={styles.topBar}>
            ...
            <View style={[styles.topStatus, isCompact && styles.compactTopStatus]}>
              <View style={[styles.avatarBadge, isCompact && styles.compactAvatarBadge]}>
                <Image
                  resizeMode="cover"
                  source={meeroCharacter}
                  style={[styles.avatarImage, isCompact && styles.compactAvatarImage]}
                />
              </View>
              <View style={[styles.pointBadge, isCompact && styles.compactPointBadge]}>
                <Text style={[styles.pointStar, isCompact && styles.compactPointStar]}>★</Text>
                <Text style={[styles.pointText, isCompact && styles.compactPointText]}>25</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.landscapeBody}>
            ...
            <View style={styles.regionColumn}>
              <View style={styles.sectionHeader}>
                ...
                />
                <Text style={styles.sectionTitle}>{homeSectionHeader.title}</Text>
              </View>
...
function RegionCard({
  ...
  return (
    <Pressable
      ...
      <View style={[styles.regionContent, isCompact && styles.compactRegionContent]}>
        <Text style={[styles.regionTitle, isCompact && styles.compactRegionTitle]}>
          {region.title}
        </Text>
  ...
  return (
    <View style={styles.starRating}>
      {[0, 1, 2].map((index) => (
        <Text
          key={index}
          style={[styles.ratingStar, index < count ? styles.ratingStarActive : styles.ratingStarIdle]}>
          ★
        </Text>
      ))}
    </View>
    ...
    <View
      ...
      {items.map((item) => (
        <Pressable
          ...
          <View style={[styles.navIconWrap, isCompact && styles.compactNavIconWrap]}>
            <Image
              resizeMode="contain"
